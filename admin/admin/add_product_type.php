...
<div class="modal fade" id="editTypeModal" tabindex="-1" role="dialog" aria-labelledby="editCategoryModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <form id="editCategoryForm" style="margin-bottom: 20px;">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                    <label class="modal-label" style="color: #259E9E;">Type Name</label>
                        <input type="text" class="form-control" id="editCategoryName" name="edit_category" placeholder="Enter Type" required>
                    </div>
                </div>
                <div class="modal-footer" style="border-top: none;">
...
<!-- this code is for the Password and confirm password does not match (makikita sa code.php)-->
            ...
            ?>
                ...
                <thead style="background-color: #259E9E; color: white;">
                        <th> ID </th>
                        <th> Type Name <button class="btn btn-link btn-sm" onclick="sortTable(1)"><i id="sortIcon" class="fas fa-sort" style="color: white;"></i></button></th>
                        <th> EDIT </th>
                    </thead>
                    <tbody>
                    <?php
