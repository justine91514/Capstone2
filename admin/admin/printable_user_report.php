...
class MYPDF extends TCPDF {
    ...
    public function Header() {
        ...
        $this->Cell(0, 90, 'User Management Reports', 0, false, 'C', 0, '', 0, false, 'T', 'M');
...
$pdf->Cell(30, 10, 'Middle Name', 1, 0, 'C', 1);
$pdf->Cell(30, 10, 'Last Name', 1, 0, 'C', 1);
$pdf->Cell(45, 10, 'Email', 1, 0, 'C', 1);
$pdf->Cell(30, 10, 'Password', 1, 0, 'C', 1);
$pdf->Cell(25, 10, 'Branch', 1, 0, 'C', 1);
$pdf->Cell(40, 10, 'User Type', 1, 1, 'C', 1);
...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    $pdf->Cell(30, 10, $row['mid_name'], 1, 0, 'C');
    $pdf->Cell(30, 10, $row['last_name'], 1, 0, 'C');
    $pdf->Cell(45, 10, $row['email'], 1, 0, 'C');
    $pdf->Cell(30, 10, $row['password'], 1, 0, 'C');
    $pdf->Cell(25, 10, $row['branch'], 1, 0, 'C');
    $pdf->Cell(40, 10, $row['usertype'], 1, 1, 'C');
    $pdf->SetX(25); // Set X position to 40
}
