...
class MYPDF extends TCPDF {
    ...
    public function Header() {
        ...
        $this->Cell(0, 90, 'Type Reports', 0, false, 'C', 0, '', 0, false, 'T', 'M');
...
$pdf->Cell(70, 8, 'Type Name', 1, 1, 'C', 1); // Adjusted width for Category Name

// Fetch data from the database
$connection = mysqli_connect("localhost", "root", "", "dbpharmacy");
$query = "SELECT * FROM product_type_list"; // Modify to your actual table name
...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    $pdf->Cell(70, 8, $row['type_name'], 1, 1, 'C', $fill); // Adjusted width for Category Name
    $pdf->SetX(108.5);
